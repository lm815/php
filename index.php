...
<div class="container">
    ...
    <form class="form-horizontal" action="index.php" method="post">
        ...
        <div class="col-md-4">
            ...
            <p><input name="view" type="radio" value="swimming"> Плавание</p>
            <p><input name="view" type="radio" value="run"> Бег</p>
            <p><input name="view" type="radio" value="jumps" checked> Прыжки в длину</p>
        </div>
    </form>
    <form class="form-horizontal" action="index.php" method="post">
...
>>>>>>> c704f641359c6ce209b55122e56b1d73cd144fe0
