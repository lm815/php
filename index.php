                    ...
                    <div class="form-group">
                        ...
                        <form class="form-horizontal" action="index.php" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="city" class="form-control" placeholder="Город проживания" required>
                                </div>
                                <form class="form-horizontal" action="index.php" method="post">
            <div class="form-group">
                <label for="phone" class="col-sm-2 control-label">Номер телефона</label>
                <div class="col-md-4">
                    <input type="text" name="phone" class="form-control" placeholder="Введите номер" required>
                </div>
            </div>
            <form class="form-horizontal" action="index.php" method="post">
                <div class="form-group">
